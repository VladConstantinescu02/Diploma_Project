...
class FilterMealState extends State<FilerMeal> {
  ...
  Future<void> _returnMealSearch() async {
    const excludeAlcoholIngredients ="vodka,rum,whiskey,brandy,beer,tequila,bourbon,cognac";

    final keywords = [
      'vodka', 'rum', 'whiskey', 'brandy', 'beer', 'tequila', 'bourbon', 'cognac', 'wine'
    ];
    ...
    final query = _dishType.text.trim();
    ...
    if (results != null) {
      ...
      if (context.mounted) {
        if (filtered.isNotEmpty) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text("No meals found (alcohol filtered).")),
          );
        }
      }
    } else {
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text("No meals found or error occurred")),
        );
      }
    }
  }
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: TemplateSlider(
                              ...
                              onChanged: (value) => setState(() => _minCalories = value),
                          ...
                          Padding(
                            ...
                            child: TemplateSlider(
                              ...
                              onChanged: (value) => setState(() => _maxCalories = value),
                          ...
                          Padding(
                            ...
                            child: ShowIntSlider(
                              ...
                              onChanged: (value) => setState(() => _resultCount = value),
                              label: 'No. of results',
                            ),
                          ),
                        ],
